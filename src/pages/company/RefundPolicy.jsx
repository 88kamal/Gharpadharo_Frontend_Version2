    ...
    return (
        <Layout>
            <div className={`container mx-auto py-4 px-4 fontPara`}>
                ...
                <h2 className='text-xl font-bold'>Refund Policy - Gharpadharo</h2>

                <br />


        <p className=' text-justify'>        
                At Gharpadharo, our priority is to provide students with comfortable and hassle-free accommodation solutions. We understand that circumstances may change, and therefore we have implemented a comprehensive refund policy to ensure your satisfaction.
                ...
                <br />
                6. Force Majeure:* In cases of unforeseen circumstances or force majeure events, such as natural disasters or government restrictions, Gharpadharo reserves the right to modify or cancel bookings without penalty.

                <br />
                <br />


                By booking accommodation through Gharpadharo, you agree to abide by the terms and conditions outlined in this refund policy. For further inquiries or clarification regarding our refund policy, please refer to our website or contact our customer support team.     </p>       
                </div>
        </Layout>
    );
}
